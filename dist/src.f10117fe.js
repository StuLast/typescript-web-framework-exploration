...
function () {
  ...
  User.prototype.save = function () {
    if (!this.data.id) {
      axios_1.default.post('http://localhost:3000/users', JSON.stringify(this.data)).then(function (res) {
        console.log(res);
      });
      return;
    }

    axios_1.default.put("http://localhost:3000/users/" + this.data.id, JSON.stringify(this.data)).then(function (res) {
      console.log(res);
    });
    return;
  };
